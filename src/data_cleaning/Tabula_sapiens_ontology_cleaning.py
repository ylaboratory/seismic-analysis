...
cl_graph = obonet.read_obo("data/ref/cell_ontology/cl.obo") #this can be downloaded from the website: https://obofoundry.org/ontology/cl.html
...
cl_class.loc[cl_class.cell_ontology_class=="nk cell","official_name"] = "natural killer cell"
...
cl_class.loc[cl_class.cell_ontology_class=="hillock-club cell of prostate epithelium","official_name"] = "hillock cell of prostatic urethral epithelium"
...
cl_class.loc[cl_class.cell_ontology_class=="club cell of prostate epithelium","official_name"] = "club-like cell of the urethral epithelium"
cl_class.loc[cl_class.cell_ontology_class=="hillock cell of prostate epithelium","official_name"] = "hillock cell of prostatic urethral epithelium"
...
cl_class = cl_class[cl_class["cl_term"].startswith("CL")]
