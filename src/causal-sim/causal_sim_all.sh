...
# scDesign3 expanded
nohup Rscript src/causal-sim/causal_sim.R data/causal_sim/sc3_standard/perturbed_expr/parameter_df.txt\
results/causal_sim/sc3_standard output_header target_cell_type FALSE TRUE $NUM_CORE &

nohup python -u src/causal-sim/scdrs_causal_sim.py data/causal_sim/sc3_standard/perturbed_expr/parameter_df.txt \
...
# multiple cell types
# random 
nohup Rscript src/causal-sim/causal_sim.R data/causal_sim/sc3_multi_ct/random/perturbed_expr/parameter_df.txt \
results/causal_sim/sc3_multi_ct/random output_header target_cell_type TRUE TRUE $NUM_CORE &

nohup python -u src/causal-sim/scdrs_causal_sim.py data/causal_sim/sc3_multi_ct/random/perturbed_expr/parameter_df.txt \
...
# no overlap
nohup Rscript src/causal-sim/causal_sim.R data/causal_sim/sc3_multi_ct/no_overlap/perturbed_expr/parameter_df.txt\
results/causal_sim/sc3_multi_ct/no_overlap output_header target_cell_type TRUE TRUE $NUM_CORE &

nohup python -u src/causal-sim/scdrs_causal_sim.py data/causal_sim/sc3_multi_ct/no_overlap/perturbed_expr/parameter_df.txt \
...
# ct overlap
nohup Rscript src/causal-sim/causal_sim.R data/causal_sim/sc3_multi_ct/ct_overlap/perturbed_expr/parameter_df.txt\
results/causal_sim/sc3_multi_ct/ct_overlap output_header target_cell_type TRUE TRUE $NUM_CORE &

nohup python -u src/causal-sim/scdrs_causal_sim.py data/causal_sim/sc3_multi_ct/ct_overlap/perturbed_expr/parameter_df.txt \
...
# causal overlap
nohup Rscript src/causal-sim/causal_sim.R data/causal_sim/sc3_multi_ct/causal_overlap/perturbed_expr/parameter_df.txt\
results/causal_sim/sc3_multi_ct/causal_overlap output_header target_cell_type TRUE TRUE $NUM_CORE &

nohup python -u src/causal-sim/scdrs_causal_sim.py data/causal_sim/sc3_multi_ct/causal_overlap/perturbed_expr/parameter_df.txt \
