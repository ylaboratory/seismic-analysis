...
#print magma files
print_magma_fuma_tbl(ts_mean, "MAGMA", main_table_path = here("data","expr","Tabula_sapiens","ts.top10_magma.txt"),
...
#print fuma files
print_magma_fuma_tbl(t(ts_mean_log_hsa), "FUMA", main_table_path = here("data","expr","Tabula_sapiens","ts.fuma.txt"),
...
ts_ad %>%  write_h5ad(here("data","expr","Tabula_sapiens","ts.clean.h5ad"))
