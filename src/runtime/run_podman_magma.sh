...
podman exec $CONTAINER_NAME Rscript /grain/ql29/podman_file/scripts/magma_data_gen.R /grain/ql29/podman_file/data/tmp/$data_name /grain/ql29/podman_file/data/raw_5 /grain/ql29/podman_file/data/tmp/$res_name /grain/ql29/podman_file/data/tmp/${res_name}_test 
