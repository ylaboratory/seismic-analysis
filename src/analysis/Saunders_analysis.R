...
brain_sce$region_subclass <- paste0(brain_sce$region,".",brain_sce$subclass)
brain_sce$region_class <- paste0(brain_sce$region,".",brain_sce$class)
brain_sce$region_cluster <- paste0(brain_sce$region,".",brain_sce$cluster_anno)
...
gwas_zscore_all <- list(PD = here("data","gwas","brain_gwas","zscore","PD.genes.out"),
